  ...
  return (
    <div className="flex justify-center mx-[5vw] mt-16">
      <div className="w-full max-w-[1100px]">
        <h1 className="text-4xl text-center">Kết luận</h1>
        <p className="mt-4 mb-10 text-gray-400 text-lg text-center">{`Cuốn sổ tay hiện tại chưa đầy đủ, tương lai sẽ tiếp tục bổ sung, hoàn thiện thêm các màn hình khác`}</p>
